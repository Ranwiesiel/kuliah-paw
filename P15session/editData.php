...
if(isset($_POST["proses"])){
    ...
    $raw_jumlah = mysqli_query($koneksi, "SELECT jumlah FROM order_detil WHERE id_menu = '$_GET[kode]'");
    $jumlah = mysqli_fetch_assoc($raw_jumlah)['jumlah'];
    mysqli_query($koneksi, "UPDATE order_detil SET
    harga = '$_POST[harga_makanan]',
    subtotal = $jumlah * '$_POST[harga_makanan]'
    WHERE id_menu = '$_GET[kode]'");

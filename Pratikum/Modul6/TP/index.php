...
<body>
	<div class='container mt-5'>
		<div class="d-flex justify-content-between">
			...
			<div>
				<a href='addData.php'><button type='button' class='btn btn-success mb-5'>Tambah Data</button></a>
				<a href='barang.php'><button type='button' class='btn btn-warning mb-5 ms-2'>Lihat Barang</button></a>
			</div>
		</div>

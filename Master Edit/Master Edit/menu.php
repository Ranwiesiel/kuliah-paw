...
if(isset($_GET['sort'])){
	$data_sort = $_GET;
	if($data_sort['sort'] == 'asc'){
		$sort = $sort_by_asc;
	} elseif($data_sort['sort'] == 'desc'){
		$sort = $sort_by_desc;
	}
} else{
	$sort = $data;
			...
			<div class="col-md-auto">
				...
				<table class="table table-bordered">
				    <tr>
				        ...
				        <th>Kode Makanan</th>
				        <th>Nama Makanan 
							<?php if(!isset($data_sort['sort']) || $data_sort['sort'] == 'asc'): ?>
								<a href='menu.php?sort=desc'><i class="fa fa-sort-asc"></i></a>
							<?php else: ?>
								<a href='menu.php?sort=asc'><i class="fa fa-sort-desc"></i></a>
							<?php endif; ?>
						</th>
				        <th>Harga Makanan</th>

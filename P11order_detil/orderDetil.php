...
if(isset($_GET['idorder'])){
	...
	$raw_sql = mysqli_query($koneksi, "SELECT menu.nama_makanan, menu.harga, order_detil.jumlah, order_detil.subtotal FROM menu INNER JOIN order_detil ON (order_detil.id_menu = menu.id_makanan) WHERE order_detil.id_order = $idorder");
} else{
	$idorder = "Invalid";
}
		...
		<div class="row justify-content-center">
			<div class="col-md-auto">
				...
				<table class="table table-bordered">
				    ...
				    <?php while($row = mysqli_fetch_assoc($raw_sql)): ?>
				    	<tr>
				    		<td><?= $ind ?></td>
